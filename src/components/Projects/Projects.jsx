...
import SectionDividerTop from '../SectionDividers/SectionDividerTop';
import SectionDividerBottom from '../SectionDividers/SectionDividerBottom'
              ...
              <Fade left={isDesktop} bottom={isMobile} duration={1000} delay={500} distance="30px">
                <div className="project-wrapper__text">
                  ...
                  <div>
                    ...
                    <p className="mb-4">Something goes here.</p>
                  </div>
                  <a
                    target="_blank"
                  ...
                  <a href="#!" target="_blank" aria-label="Project Link" rel="noopener noreferrer">
                    ...
                    >
                      <div data-tilt className="thumbnail rounded">
                        <ProjectImg alt="" filename="project.jpg" />
                      </div>
                    </Tilt>
                  </a>
                </div>
